...
const QuoteCard = ({ quote: initialQuote, onToggleFavorite, onDelete }) => {
    ...
    const [isFavorited, setIsFavorited] = useState(user && user.favorites ? user.favorites.includes(quote._id) : false);
    ...
    const handleFavoriteClick = async () => {
        ...
        try {
            const res = await axios.put(`http://localhost:5001/api/quotes/${quote._id}/favorite`);
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(`http://localhost:5001/api/quotes/${quote._id}`);
    ...
    const handleSaveEdit = async () => {
        try {
            const res = await axios.put(`http://localhost:5001/api/quotes/${quote._id}`, {
                content: editContent,
